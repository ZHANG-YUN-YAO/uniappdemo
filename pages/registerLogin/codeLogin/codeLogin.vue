			...
			<view class="content">		    
				<view class="input-group">
					<view class="input-row border">
						...
						<m-input class="m-input" type="text" clearable focus v-model="account" placeholder="输入手机号"></m-input>
					</view>
					<view class="input-row">
						<image class="inputimg" style="width: 31rpx;" src="../../../static/images/codenum.png" mode=""></image>
						<!-- displayable   眼睛-->
						<m-input type="password"  v-model="password" placeholder="输入验证码"></m-input>
				...
				<view class="btn-row">
					<button id="button" class="cu-btn bg-green block lg button" @tap="bindLogin">同意协议并登录</button>
				</view>
